...
import fish.payara.security.identitystores.YubikeyCredential;
...
public class Login extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        Credential thirdCredential = new RememberMeCredential("qwertyuiop");
        securityContext.authenticate(req, resp, new AuthenticationParameters().credential(firstCredential));
        securityContext.authenticate(req, resp, new AuthenticationParameters().credential(thirdCredential));
        ...
        if (status.equals(AuthenticationStatus.SUCCESS)){
            resp.sendRedirect("/payara-twoFactor/Secured");
        } else {
            PrintWriter out = resp.getWriter();
            printHeaders(out);
    ...
    private void printHeaders(PrintWriter out){
        out.println("<html>");
        out.println("<head>");
        out.println("<title>Yubikey Authentication</title>");
        out.println("</head>");
        out.println("<body>");
    }
